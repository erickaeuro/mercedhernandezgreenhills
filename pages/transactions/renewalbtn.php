                    ...
                    <div class="card-body">
                        ...
                        ?> 
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" name="renewal_amnt">
                            </div>

                            <div class="form-group col-md-12">
                                <label for="service_charge">Service Charge</label>
                                <input type="text" class="form-control" name="service_charge" placeholder="P 0.00">
                            </div>

                            <div class="form-group col-md-12">
                                <label for="total_amount_due">Total Amount Due</label>
                                <input type="text" class="form-control" name="total_amount_due" placeholder="P 0.00">
                            </div>
                            ...
                            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#AddModal">Add Renewal Loan</button>
                            ...
                            <div class="modal" id="AddModal">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <button type="submit" name="addrenewal" class="btn btn-success editbtn">Yes</button> 
