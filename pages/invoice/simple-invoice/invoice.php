...
<!--          <?php var_dump($_REQUEST); ?>-->
        <div class="table-responsive">
          ...
          <div class="container-fluid">
            <div class="navbar-header" >
             <a class=" navbar-brand" href="invoice.php?add=1">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
             &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Invoice System</a>
            </div>
          </div>
        </nav>
                ...
                <td colspan="2">
                  ...
                  <table id="invoice-item-table" class="table table-bordered table-hover table-striped">
                    <tr>
                      ...
                      <th width="12.5%" colspan="2">Interest (%)</th>
                      <th width="12.5%" colspan="2">Principal (%)</th>
                      <th width="12.5%" colspan="2">Total Payment Due </th>
          ...
          for(j=1; j<=count; j++)
          {
            ...
            if(quantity > 0)
            {
              ...
              if(price > 0)
              {
                ...
                if(tax3_rate > 0)
                {
                  tax3_amount = parseFloat(tax3_rate);
      ...
      <div class="container">
        <div class="navbar-header">
          <a class="navbar-brand" href="#">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
            Invoice System</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <form class="navbar-form navbar-right">
