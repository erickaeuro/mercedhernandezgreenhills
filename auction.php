...
<title>Auction | Merced Hernandez Greenhills</title>
          ...
          <!-- Content Row -->
                ...
                <div class="col-xl-12 col-lg-12">
                  <div class="card shadow mb-4 border-left-primary border-bottom-primary">
                      ...
                      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                          <h6 class="m-0 font-weight-bold text-dark">Auction</h6>
                      </div>
                      <!-- Card Body -->
                      <?php 
                      ...
                      <div class="card-body">
                          <div class="table-responsive">
                              <table class="table table-stripped" id="ccc" width="100%" cellspacing="0">
                                  <thead>
            ...
            ?>  
                                  <tr>
                                    ...
                                    <a href="auctionsold.php?id=<?= $row['auctionid'];?>" class="btn text-white" style="background-color: #87578F;" onclick="return confirm('Are you sure you want to sell this item?')">SELL</a>
                                    </td>
                                  </tr> 
                                  <?php           
                    }
