...
(60, 'Nina', '', 'Ford', 'TGU0Q011ZWE1ZHI2cHRhbERtaU92M3c5dUhhSDZWRnVBNjFXVE5XaFMxaz06Os2zaPjsfsKWpbHyPQAgiHc=', 'RG9VVzUvd3dIRnBXMFBKS1JsTGxIQT09OjrDCx49lqagTpmzkDqWrb/5', '2001-10-10', '', 'SjhHNU1qM25YaldRZWZuLzFzaFdwK0xOMEJONHpFbHVZVkxuYUtlMlVMWDNCWHA1cy85VmllL2o2ZGFFRThFSzo6e5hDNDqk7V34vmyECo/zrg==');
...
--
ALTER TABLE `customertbl`
  MODIFY `customer_no` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;

--
-- AUTO_INCREMENT for table `inventorytbl`
--
ALTER TABLE `inventorytbl`
  MODIFY `stock_no` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `pawntickettbl`
  MODIFY `pawnticketno` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
