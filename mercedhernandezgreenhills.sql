...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 08, 2022 at 03:06 PM
...
(9, 'Charles Abiog', 'YXVydjJWbTBoRjNhSzhnR1M2Z3NQdz09Ojo8OqAQf02EP4F8saqlEOOq', 'QmN1QjJlYUh', '2004-12-30', 'Qy92SGpvcW5USEExSHE0VGNtMW1yZz09Ojotl8HGPyonh1CBlWlMbLsJ'),
(10, 'JC De Sagon', 'Smw2bGRmU3BSMmpVTjMzeEd2MXFneUozVHc3cHpEUXBVZ0NwMmt6eWxLVT06OpR+LsK2miggbNeUHO9jezE=', 'M3BIM2ZlVTV', '2004-12-30', 'SytiSnV5TGNDeS9Kb0c1UnkzNGJTdz09Ojqf8GCMwbbae+ilGZ+CXFEe');
...
(5, 'Earring', 'Heart Earrings', '18', 'Gold', '3.2', 1, '7000.00', '0000-00-00', 0, '2022-10-08 11:15:57');
...
--
ALTER TABLE `customertbl`
  MODIFY `customerno` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `inventorytbl`
--
ALTER TABLE `inventorytbl`
  MODIFY `stock_no` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `pawntickettbl`
  MODIFY `pawnticketno` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `renewaltbl`
  MODIFY `renewalid` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
