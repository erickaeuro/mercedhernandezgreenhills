...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 14, 2022 at 08:42 PM
...
CREATE TABLE `loantbl` (
  ...
  `total_amt_due` int(255) NOT NULL,
...
INSERT INTO `loantbl` (`loan_id`, `customer_no`, `item_type`, `item_desc`, `appraised_value`, `principal`, `interest`, `date_loan_granted`, `maturity_date`, `expiry_date`, `total_amt_paid`, `total_amt_due`, `loan_status`) VALUES
(1003, 8, 'Pendant', 'Golden Pendant', 4100, 900, '5.00', '2022-10-14', '2022-11-14', '2023-01-14', 315, 0, 'Active Loan'),
(1004, 5, 'Wrist Watch', 'Rolex', 2000, 400, '5.00', '2022-10-14', '2022-11-14', '2023-01-14', 0, 0, 'Active Loan'),
(1005, 2, 'Bracelet', 'Cool Colored Bracelet', 3030, 600, '5.00', '2022-10-15', '2022-11-15', '2023-01-15', 0, 0, 'Active Loan'),
(1006, 6, 'Ring', 'Ruby Ring', 5000, 1100, '5.00', '2022-10-15', '2022-11-15', '2023-01-15', 0, 1155, 'Active Loan');
...
(10, 1003, '2022-10-14', 500, 'Renewal'),
(12, 1003, '2022-10-14', 315, 'Renewal');
