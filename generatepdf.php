...
$pdf->Ln(8);
$pdf->Cell(51,3,'Mr./Ms./Miss: '.$fulln.'',0,1);
$pdf->Ln(2);
...
$pdf->Ln(10);
$pdf->Cell(51,3,'for a loan of PESOS (P '.$principal.') with an interest of',0,0);
$pdf->Ln(10);
$pdf->Cell(51,3,'_____________ Percent ( '.$interest.' % ) for (30 Days/Month) P.M/P.A) has pledge to this Pawnee in security for the loan the article(s)',0,0);
$pdf->Ln(10);
$pdf->Cell(51,3,'described below appraised at PESOS __________________________________________________________ (P '.$appraised_value.')',0,0);
$pdf->Ln(5);
$pdf->Cell(270, 5, '(Appraised Value)',0,1,'C');
$pdf->Ln(5);
...
$pdf->MultiCell(200, 2,'TERMS AND CONDITIONS

1.  The pawner hereby accepts the pawnshops appraisal as proper.
...
3.  The service charge is equivalent to one percent (1%) of the principal loan, but not to exceed five pesos (P5.00). No other charges shall be collected.

4.  This loan is renewable for such amount and period as may be agreed upon between the pawnshop and the pawner, subject to the requirements of P.D. 114 for a new loan.
...
9.  The pawner shall not be entitled to the excess of the public auction sale price over the amount of principal, interest and service fee; neither shall the pawnshop be entitled to recover the deficiency from the pawner.
...
11. The pawnshop shall not be liable for loss or damage of the pawn due to fortuitous events without fault or negligence on its part, while the pawn is in its possession.

12. The pawnshop shall exercise reasonable care and caution that an ordinary prudent person would as to his own property over the thing pawned in accordance with Republic Act No. 386 (Civil Code of the Philippines), as amended. Accordingly, the pawnshop shall insure all pawned items, except those which are kept inside a fireproof vault, in accordance with the pertinent regulation of the Bangko Sentral ng Pilipinas. Claims for retitution by pawner in case of loss, destruction or defect of the pawn due to robbery, fire and other directors and officers are cognizable by the regular courts.

13. Venue of all judicial and administrative cases or proceedings and other legal incidents arising out of or in connection with this contract shall solely and exclusively be brought before the appropriate courts, departments, offices or agencies of the government situated in Mandaluyong City.

14. The authorized representative must present valid identification papers.

15. The pawner shall advise the pawnshop of any change of address.

16. Acknowledgment: I hereby declare that the above mentioned article(s) is/are my personal property and are free from liens and encumbrances.
