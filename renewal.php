...
<title>Renewal | Merced Hernandez Greenhills</title>
      ...
      <div id="content">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4"> 
                ...
                <div class="col-xl-12 col-lg-12">
                  <div class="card shadow mb-4 border-left-primary border-bottom-primary">
                      ...
                      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                          <h6 class="m-0 font-weight-bold text-dark">Renewal Loans</h6>
                      </div>
                      ...
                      ?> 
                          ...
                          <div class="table-responsive">
                              <table class="table table-stripped" id="aaa" width="100%" cellspacing="0">
                                  <thead>
          ...
          ?>
                                  ...
                                  <td>
                                      <a href="renewalview.php?id=<?= $row['loan_id'];?>" class="btn text-white" style="background-color: #7FD2D4;">VIEW</a>                                      
                                  </td>
                            </tr>
                <?php 
